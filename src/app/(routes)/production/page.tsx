...
export default function Contact() {
  return (
    <div className="grid gap-4">
      ...
      <ProdIntroSec header="Recyclable Packaging" reverse text="The foil we use for HEY YUM! is type (pp). It is suitable for recycling and comply with EU food regulations. Please make sure to recycle the empty foil bag by placing it the waste containers for recyclable soft plast. In that way together we can reduce the consumption of non-renewable raw materials." src="threePackonBg.png" />
      <div className="air w-full md:h-[70] h-[30]"></div>
      <ProductionProcess />
