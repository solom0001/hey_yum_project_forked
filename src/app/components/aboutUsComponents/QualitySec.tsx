...
const itemVariants = {
  ...
  visible: { opacity: 1, x: 0, transition: { duration: 0.6, ease:"easeInOut" as any } },
};
...
const QualitySec = () => {
  ...
  return (
    <section className="S_Content_width">
      <motion.div initial="hidden" className="grid grid-cols-1 md:grid-cols-[1fr_1fr] md:auto-rows-auto gap-x-10 gap-y-16 mx-auto col-start-2">
        ...
        <motion.div variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} className="md:mt-[50%] overflow-hidden">
