...
const ProductionProcess = () => {
  return (
    <div className="fullbleed bg-(--black) ContentWitdh">
      <div className="flex flex-col w-full md:grid grid-cols-2 gap-8  text-(--white)!">
        {/*Sticky image */}
        <div className="relative w-full h-full bg-[url(/assets/images/production/rainbow_bg2.svg)]  bg-contain bg-center bg-no-repeat">
          <div className="md:sticky top-0  md:aspect-auto md:w-[70%] mx-auto overflow-hidden grid *:col-1! *:row-1">
            <h1 className="mt-10 pt-8 text-[2.5rem]! md:text-(--black) relative z-10 text-center">The making of Hey Yum!</h1>
        ...
        <div className="flex flex-col h-full gap-12 pt-8 ">
          ...
          <StepComp title="Molding" src="molds_heyYum.jpg" step="2" text=" A board of molds is pressed into wooden trays. The liquid mass then gets filled in those small wells created by the moulds. The gummy candies are then lying flat on their bellies until they get dry and keep their shape. In this way, six different colored fruit gums can be made at the same time." />
